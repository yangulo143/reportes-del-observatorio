...
format:
  html:
    ...
    self-contained: true
    page-layout: full
footer: "Fuente de datos: Scopus | Fecha de búsqueda: 04/12/2025"
output-dir: docs
---
...
tryCatch({
  raw_data <- read_csv("scopus social determinantes.csv", show_col_types = FALSE)
}, error = function(e) {
...
Este informe analiza un total de **`r nrow(data_processed)`** documentos científicos publicados hasta el año **2025**, que abarcan aspectos sobre determinantes sociales de la salud y son publicados por al menos un autor que tiene filiación en Perú.

La estrategia incluye el analisis de los siguientes conceptos: Inequidades en salud, determinantes sociales de las salud, disparidades sociales, económicas, y factores socioeconomicos asociados a la salud.  
