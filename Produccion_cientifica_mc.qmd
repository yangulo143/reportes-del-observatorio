...
tryCatch({
  ...
  stop("No se encontró el archivo 'scopus3.csv'. Asegúrate de que esté en la carpeta del proyecto.")
})
...
Este informe analiza un total de **`r nrow(data_processed)`** documentos científicos publicados hasta el año **2025**, que abarcan temas de medicina complementaria y son publicados por al menos un autor que tiene filiación en Perú.
